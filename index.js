...
function getEvenNumbers(arr) {
  ...
  for (let i = 0; i < arr.length; i++) {
    if (arr[i] % 2 === 0) {
      newArrow[newArrow.length] = arr[i];
    }
  }
  return newArrow;
...
function multiplyByIndex(arr) {
  let newArrow = [];
  for (let i = 0; i < arr.length; i++) {
    newArrow[newArrow.length] = arr[i] * i;
  }
  return newArrow;
  // Створюємо пустий масив для зберігання результату
  // Проходимо через кожен елемент вхідного масиву
...
function replaceNumbers(arr) {
  ...
  for (let i = 0; i < arr.length; i++) {
    if (arr[i] > 10) {
      newArrow[newArrow.length] = "Greater than 10"
    } else if (arr[i] <= 10) {
      newArrow[newArrow.length] = "Less than or equal to 10"
    }
  }
  return newArrow
  // Створюємо пустий масив для зберігання результату
